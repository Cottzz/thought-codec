...
required_files=(
  ...
  "docs/brand/logo-review-criteria.md"
  "docs/brand/logo-review-board.md"
  "docs/brand/logo-routes.json"
  "assets/brand/logo-routes/route-01-codec-core.svg"
  "assets/brand/logo-routes/route-02-bidirectional-flow.svg"
  "assets/brand/logo-routes/route-03-modular-grid.svg"
  "assets/brand/logo-routes/route-04-signal-mark.svg"
  "assets/brand/logo-routes/route-05-wordmark-first.svg"
  "assets/brand/logo-routes/route-06-processing-flow.svg"
  "assets/diagrams/architecture.svg"
  "assets/diagrams/decompression-compression.svg"
  "assets/diagrams/agentic-loop.svg"
  "skills/README.md"
  "skills/_template/SKILL.md"
  "skills/_template/SKILL.zh-CN.md"
  "catalog/skills.json"
